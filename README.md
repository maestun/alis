...
| Robinson's Requiem      | ${\textsf{\color{red}Broken}}$               | ${\textsf{\color{green}Playable}}$           | ${\textsf{\color{red}Broken}}$               | ${\textsf{\color{green}Playable}}$           | ${\textsf{\color{orange}Bugged}}$            | ${\textsf{\color{red}Broken}}$               | ${\textsf{\small\color{gray}Not \ Working}}$ | ${\textsf{\small\color{gray}Not \ Working}}$ | ${\textsf{\color{gray}-}}$                   | ${\textsf{\color{gray}-}}$                   | ${\textsf{\color{gray}-}}$                   |
